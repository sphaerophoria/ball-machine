...
pub const Vtable = struct {
    initChamber: *const fn (self: ?*anyopaque, max_balls: usize, max_canvas_pixels: usize) anyerror!void,
...
pub fn initChamber(self: Chamber, max_balls: usize, max_canvas_pixels: usize) !void {
    return self.vtable.initChamber(self.data, max_balls, max_canvas_pixels);
}
